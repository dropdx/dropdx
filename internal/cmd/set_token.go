...
func init() {
	...
	setTokenCmd.Flags().StringVar(&tokenExp, "exp", "30d", "Expiration duration (7d, 30d, 60d, 90d) or custom date (YYYY-MM-DD)")
...
func parseExpiration(exp string) (string, error) {
	...
	default:
		...
		if err != nil {
			return "", fmt.Errorf("use shortcuts (7d, 30d, 60d, 90d) or format YYYY-MM-DD")
		}
